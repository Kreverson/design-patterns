...
public class WhatsAppNotification implements NotificationStrategy {
    private final Logger logger = LoggerFactory.getLogger(WhatsAppNotification.class);

    @Override
    public void sendNotification(Notification notification) {
        //logic
        logger.info(MessageFormat.format("Whatsapp message sended to {0}", notification.getDestination()));
    }
}
